            ...
            <div class="page-banner ovbl-dark" style="background-image:url(assets/images/banner/banner2.jpg);">
                <div class="container">
                    <div class="page-banner-entry">
                        <h1 class="text-white">Our Fee Structure</h1>
                    </div>
                </div>
            </div>
            <!-- Breadcrumb row -->
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-md-12 heading-bx text-center">
                                <h2 class="title-head text-uppercase m-b0">School Fee and other Levies <br /> <span>
                                        Below are our afordable fee</span></h2>
