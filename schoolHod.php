            ...
            <div class="page-banner ovbl-dark" style="background-image:url(assets/images/banner/banner2.jpg);">
                <div class="container">
                    <div class="page-banner-entry">
                        <h1 class="text-white">The School H.O.Ds</h1>
                    </div>
                </div>
            </div>
            <!-- Breadcrumb row -->
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-md-12 text-center heading-bx text-white">
                                <h2 class="title-head m-b0">The School <span>H.O.Ds</span></h2>
                            </div>
                            <div class="col-md-12">
                                <div class="news-gallery36">
                                   ...
                                   <div class="col-md-4">
                                    <div class="card">
                                        <div class="card-header">
                                            <div class="card-title">
                                                 <h3 class="text-info text-center">H.O.D Commercial</h3>
                                            </div>
                                        </div>
                                        <div class="card-body">
                                          ...
                                          <div class="card-footer">
                                            <h3 class="text-center">Mrs Blessing T.A</h3>
                                        </div>
                                    </div>
                                    ...
                                    <div class="card">
                                        <div class="card-header">
                                            <div class="card-title">
                                                 <h3 class="text-info text-center"> H.O.D Science</h3>
                                            </div>
                                        </div>
                                        <div class="card-body">
                                             <a href="assets/images/gallery/pic1.jpg" class="magnific-anchor "><img
                                    ...
                                    <div class="card">
                                        <div class="card-header">
                                            <div class="card-title">
                                                 <h3 class="text-info text-center">H.O.D Art & Humanity</h3>
                                            </div>
                                        </div>
                                        <div class="card-body">
                                             <a href="assets/images/gallery/pic1.jpg" class="magnific-anchor "><img
