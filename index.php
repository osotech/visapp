...
<body id="bg">
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-6">
                                <div class="service-bx">
                                    ...
                                    <div class="info-bx text-center">
                                        ...
                                        <h4><a href="#">Well Equiped Library</a></h4>
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-6">
                                <div class="service-bx">
                                    ...
                                    <div class="info-bx text-center">
                                        ...
                                        <h4><a href="#">Online Learning Facility</a></h4>
                                        <a href="#" class="btn radius-xl">View More</a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-4 col-sm-12">
                                <div class="service-bx m-b0">
                                    ...
                                    <div class="info-bx text-center">
                                        ...
                                        <h4><a href="#">Government Approved</a></h4>
                                        <a href="#" class="btn radius-xl">View More</a>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="cours-bx">
                                        ...
                                        <div class="info-bx text-center">
                                            <h5><a href="#"><?php echo $row['staff_title'];?>
                                                    <?php echo $row['first_name']." ".$row['last_name']; ?></a></h5>
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-md-12 heading-bx left">
                                ...
                                <span><button class="btn popupBtn">Click me</button></span>
                                <p>It is a long established fact that a reader will be distracted by the readable
                                    content of a page</p>
                            </div>
                        </div>
    ...
    jQuery(document).ready(function() {
        jQuery(".popupBtn").on('click', function() {
            window.open("login.php", "Popup", "toolbar=no,width=500,height=300");
        })
        var ttrevapi;
        var tpj = jQuery;
