                            ...
                            <div class="col-lg-3 col-md-6 col-sm-6 m-b30">
                                <div class="feature-container">
                                    ...
                                    <div class="icon-content">
                                        <h5 class="ttr-tilte">Our Core Values</h5>
                                        <p>EXCELLENCE</p>
                                        <p>SINCERITY</p>
                                        <p>INTEGRITY</p>
                                        <p>EFFICIENCY</p>
                            ...
                            <div class="col-lg-3 col-md-6 col-sm-6 m-b30">
                                <div class="feature-container">
                                    ...
                                    <div class="icon-content">
                                        ...
                                        <p>To establish an Islamic and western institution for the present and future
                                            generation in the most conducive environment</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-3 col-md-6 col-sm-6 m-b30">
                                <div class="feature-container">
                                    ...
                                    <div class="icon-content">
                                        ...
                                        <p>To Produce Generation of high integrity and moral values with academic
                                            excellence that will cope favourably in the comptemporary world</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-3 col-md-6 col-sm-6 m-b30">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-3 col-md-6 col-sm-6 col-6 m-b30">
                                    <div class="counter-style-1">
                                        ...
                                        <span class="counter-text">Seasioning Staff</span>
                                    </div>
                                </div>
                                <div class="col-lg-3 col-md-6 col-sm-6 col-6 m-b30">
                                    <div class="counter-style-1">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="join-content-bx text-white">
                                    <h2>Admission into all Classes <br /> in Progress!</h2>
                                   
                                    <h3>Hurry up and Click the link below to Register</h3>
                                    <a href="#" class="btn button-md">Start your Admission Now</a>
                                </div>
                            </div>
                        </div>
                    </div>
